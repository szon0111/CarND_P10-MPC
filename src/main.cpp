    ...
    if (sdata.size() > 2 && sdata[0] == '4' && sdata[1] == '2') {
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          // transform points to vehicle's coordinates
...
g
          ...
          double steer_value = vars[0] / (deg2rad(25) * Lf); // normalize [-1, 1]
          ...
          double poly_line = 2.5;
          int num_points = 25;

          for (int i = 1; i < num_points; i++) {
            next_x_vals.push_back(poly_line * i);
            next_y_vals.push_back(polyeval(coeffs, poly_line * i));
          }
